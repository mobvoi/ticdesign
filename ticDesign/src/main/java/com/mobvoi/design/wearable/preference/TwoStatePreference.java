...
public abstract class TwoStatePreference extends Preference {
    ...
    static class ViewHolder extends Preference.ViewHolder {
        ...
        protected void bindPreferenceToData(@NonNull Preference preference) {
            ...
            /**
             * Set summary with the correct summary text.
             */
            CharSequence summary = null;
            if (isChecked && !TextUtils.isEmpty(twoStatePreference.getSummaryOn())) {
                summary = twoStatePreference.getSummaryOn();
                useDefaultSummary = false;
            } else if (!isChecked && !TextUtils.isEmpty(twoStatePreference.getSummaryOff())) {
                summary = twoStatePreference.getSummaryOff();
                useDefaultSummary = false;
            }
