...
package com.mobvoi.design.wearable.widget;
...
import com.mobvoi.design.wearable.R;
 ...
 *
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_collapsedTitleTextAppearance
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleTextAppearance
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_contentScrim
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleMargin
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleMarginStart
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleMarginEnd
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleMarginBottom
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_statusBarScrim
 * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_toolbarId
 */
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private com.mobvoi.design.wearable.widget.AppBarLayout.OnOffsetChangedListener mOnOffsetChangedListener;
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof com.mobvoi.design.wearable.widget.AppBarLayout) {
            if (mOnOffsetChangedListener == null) {
                mOnOffsetChangedListener = new OffsetUpdateListener();
            }
            ((com.mobvoi.design.wearable.widget.AppBarLayout) parent).addOnOffsetChangedListener(mOnOffsetChangedListener);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        final ViewParent parent = getParent();
        if (mOnOffsetChangedListener != null && parent instanceof com.mobvoi.design.wearable.widget.AppBarLayout) {
            ((com.mobvoi.design.wearable.widget.AppBarLayout) parent).removeOnOffsetChangedListener(mOnOffsetChangedListener);
        }
     ...
     * the title itself.
     *
     * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_collapsedTitleGravity
     */
     ...
     * the title itself.
     *
     * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleGravity
     */
     ...
     * @attr ref com.mobvoi.design.wearable.R.styleable#CollapsingToolbarLayout_expandedTitleMarginTop
     */
    ...
    private class OffsetUpdateListener implements com.mobvoi.design.wearable.widget.AppBarLayout.OnOffsetChangedListener {
        @Override
        public void onOffsetChanged(com.mobvoi.design.wearable.widget.AppBarLayout layout, int verticalOffset) {
