 ...
 *
 * Porting from https://github.com/JakeWharton/ViewPagerIndicator
 */
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.tic_CirclePageIndicatorStyle);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float allRadius = (count * 2 * mRadius) + (count - 1) * mRadius + 1;
        final float threeRadius = mRadius * 3;
        final float shortOffset = shortPaddingBefore + mRadius;
        float longOffset = longPaddingBefore + mRadius;
        if (mCentered) {
            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - (allRadius / 2.0f);
        }
