...
abstract class FloatingActionButtonImpl {
    ...
    abstract void minimize(@Nullable InternalVisibilityChangedListener listener, boolean fromUser);
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(
                resources.getColor(R.color.tic_design_fab_stroke_top_outer_color),
                resources.getColor(R.color.tic_design_fab_stroke_top_inner_color),
                resources.getColor(R.color.tic_design_fab_stroke_end_inner_color),
                resources.getColor(R.color.tic_design_fab_stroke_end_outer_color));
