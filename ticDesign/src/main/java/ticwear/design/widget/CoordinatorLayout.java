...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        ...
        // Always accept the nested scroll if we can scroll to enable over scroll effects.
        return handled || canScrollOnAxes(nestedScrollAxes);
    }

    private boolean canScrollOnAxes(int nestedScrollAxes) {
        ...
        if ((nestedScrollAxes & ViewCompat.SCROLL_AXIS_HORIZONTAL) != 0) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(
                    ...
                    Gravity.NO_GRAVITY);
            mAnchorId = a.getResourceId(R.styleable.CoordinatorLayout_LayoutParams_tic_layout_anchor,
                    View.NO_ID);
            this.anchorGravity = a.getInteger(
                    R.styleable.CoordinatorLayout_LayoutParams_tic_layout_anchorGravity,
                    Gravity.NO_GRAVITY);

            this.keyline = a.getInteger(R.styleable.CoordinatorLayout_LayoutParams_tic_layout_keyline,
                    -1);

            mBehaviorResolved = a.hasValue(
                    R.styleable.CoordinatorLayout_LayoutParams_tic_layout_behavior);
