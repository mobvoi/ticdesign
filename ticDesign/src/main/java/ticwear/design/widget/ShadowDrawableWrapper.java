...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable content, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.tic_design_fab_shadow_start_color);
        mShadowMiddleColor = resources.getColor(R.color.tic_design_fab_shadow_mid_color);
        mShadowEndColor = resources.getColor(R.color.tic_design_fab_shadow_end_color);
