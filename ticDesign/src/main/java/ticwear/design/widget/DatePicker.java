...
public class DatePicker extends FrameLayout implements MultiPickerContainer,
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int mode = a.getInt(R.styleable.DatePicker_android_datePickerMode, MODE_SPINNER);
        final int firstDayOfWeek = a.getInt(R.styleable.DatePicker_android_firstDayOfWeek, 0);
        a.recycle();
    ...
    private static class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
        ...
        DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs,
            ...
            int layoutResourceId = attributesArray.getResourceId(
                    R.styleable.DatePicker_tic_legacyLayout, R.layout.date_picker_ticwear);
            mAllowNumericMonths = attributesArray.getBoolean(R.styleable.DatePicker_tic_allowNumericMonths, true);
            ...
            mSpinners = (LinearLayout) mDelegator.findViewById(R.id.tic_pickers);

            // calendar view day-picker
            mCalendarView = (CalendarView) mDelegator.findViewById(R.id.tic_calendar_view);
            ...
            // day
            mDaySpinner = (NumberPicker) mDelegator.findViewById(R.id.tic_day);
            ...
            // month
            mMonthSpinner = (NumberPicker) mDelegator.findViewById(R.id.tic_month);
        ...
        private boolean usingNumericMonths() {
            return mAllowNumericMonths && Character.isDigit(mShortMonths[Calendar.JANUARY].charAt(0));
        }
