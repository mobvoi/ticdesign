...
public class NumberPicker extends LinearLayout implements SidePanelEventDispatcher {
    ...
    public NumberPicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.tic_numberPickerStyle);
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.NumberPicker_tic_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mHideWheelUntilFocused = attributesArray.getBoolean(
            R.styleable.NumberPicker_tic_hideWheelUntilFocused, false);

        mSolidColor = attributesArray.getColor(R.styleable.NumberPicker_tic_solidColor, 0);
...
//            }
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_tic_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        if (!mHasSelectorWheel) {
            mIncrementButton = (ImageButton) findViewById(R.id.tic_increment);
        ...
        // decrement button
        if (!mHasSelectorWheel) {
            mDecrementButton = (ImageButton) findViewById(R.id.tic_decrement);
