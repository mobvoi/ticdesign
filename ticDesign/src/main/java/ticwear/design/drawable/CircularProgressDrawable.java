...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	public static class Builder{
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
			...
			strokeSize(a.getDimensionPixelSize(R.styleable.CircularProgressDrawable_cpd_strokeSize, ThemeUtils.dpToPx(context, 4)));
			strokeColors(a.getColor(R.styleable.CircularProgressDrawable_cpd_strokeColor, ThemeUtils.colorPrimary(context, 0xFF000000)));
			...
			progressMode(a.getInteger(R.styleable.CircularProgressDrawable_pv_progressMode, MODE_INDETERMINATE));
