...
public abstract class DialogPreference extends Preference implements
    ...
    public DialogPreference(
        ...
        mPositiveButtonIcon = a.getDrawable(R.styleable.DialogPreference_tic_positiveButtonIcon);
        mNegativeButtonIcon = a.getDrawable(R.styleable.DialogPreference_tic_negativeButtonIcon);
        mDialogLayoutResId = a.getResourceId(R.styleable.DialogPreference_android_dialogLayout,
                mDialogLayoutResId);
        a.recycle();
    }
    ...
    /**
     * Sets the icon of the positive button of the dialog. This will be shown on
     * subsequent dialogs.
     *
     * @param positiveButtonIcon The icon of the positive button.
     */
    public void setPositiveButtonIcon(Drawable positiveButtonIcon) {
        mPositiveButtonIcon = positiveButtonIcon;
    }

    /**
     * @see #setPositiveButtonIcon(Drawable)
     * @param positiveButtonIconResId The positive button icon as a resource.
     */
    public void setPositiveButtonIcon(int positiveButtonIconResId) {
        setPositiveButtonIcon(getContext().getDrawable(positiveButtonIconResId));
    }

    /**
     * Returns the icon of the positive button to be shown on subsequent
     * dialogs.
     *
     * @return The icon of the positive button.
     */
    public Drawable getPositiveButtonIcon() {
        return mPositiveButtonIcon;
    }

    /**
     * Sets the icon of the negative button of the dialog. This will be shown on
     * subsequent dialogs.
     *
     * @param negativeButtonIcon The icon of the negative button.
     */
    public void setNegativeButtonIcon(Drawable negativeButtonIcon) {
        mNegativeButtonIcon = negativeButtonIcon;
    }

    /**
     * @see #setNegativeButtonIcon(Drawable)
     * @param negativeButtonIconResId The negative button icon as a resource.
     */
    public void setNegativeButtonIcon(int negativeButtonIconResId) {
        setNegativeButtonIcon(getContext().getDrawable(negativeButtonIconResId));
    }

    /**
     * Returns the icon of the negative button to be shown on subsequent
     * dialogs.
     *
     * @return The icon of the negative button.
     */
    public Drawable getNegativeButtonIcon() {
        return mNegativeButtonIcon;
    }
    ...
    protected void showDialog(Bundle state) {
        ...
        mBuilder = new AlertDialog.Builder(context)
            ...
            .setPositiveButton(mNegativeButtonIcon, this)
            .setNegativeButton(mNegativeButtonIcon, this);
