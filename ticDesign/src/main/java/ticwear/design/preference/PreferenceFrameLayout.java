...
/**
 * android.preference.PreferenceFrameLayout is hidden, we need to implement by ourselves.
 */
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.tic_preferenceFrameLayoutStyle);
    }
    ...
    public PreferenceFrameLayout(
        ...
        mBorderTop = a.getDimensionPixelSize(
                R.styleable.PreferenceFrameLayout_tic_borderTop,
                defaultBorderTop);
        mBorderBottom = a.getDimensionPixelSize(
                R.styleable.PreferenceFrameLayout_tic_borderBottom,
                defaultBottomPadding);
        mBorderLeft = a.getDimensionPixelSize(
                R.styleable.PreferenceFrameLayout_tic_borderLeft,
                defaultLeftPadding);
        mBorderRight = a.getDimensionPixelSize(
                R.styleable.PreferenceFrameLayout_tic_borderRight,
                defaultRightPadding);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            removeBorders = a.getBoolean(
                    R.styleable.PreferenceFrameLayout_Layout_tic_layout_removeBorders,
                    false);
            a.recycle();
        }
